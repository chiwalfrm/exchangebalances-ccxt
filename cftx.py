...
if my_api_subaccount != '':
        ftx = ccxt.ftx({'apiKey': my_api_key, 'secret': my_api_secret, 'enableRateLimit': True, 'headers': {'FTX-SUBACCOUNT': 'ape'}})
else:
        ftx = ccxt.ftx({'apiKey': my_api_key, 'secret': my_api_secret, 'enableRateLimit': True})
